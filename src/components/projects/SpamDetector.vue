    ...
    <v-layout row wrap align-start>
      ...
      <v-flex xs12 my-2 text-xs-center text-sm-left>
        ...
        <v-tooltip top>
          ...
          <span>Natural Language Toolkit for Python</span>
        </v-tooltip>
      ...
      <v-flex xs12 mt-2>
        ...
        <div class="mt-3 text-xs-center">
          ...
          <a
            class="btn btn--raised grey lighten-3 grey--text text--darken-2"
            href="https://github.com/charonchan1991/tweet-emotion-spam-detection"
            target="_blank"
          >
